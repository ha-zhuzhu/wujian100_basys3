...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/designs/wujian100/soc/sim_lib/STD_CELL.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/ahb_matrix_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/aou_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/params/apb0_params.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/apb0.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/apb0_sub_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/params/apb1_params.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/apb1.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/apb1_sub_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/clkgen.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/common.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/core_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/dmac.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/dummy.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/sim_lib/fpga_byte_spram.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/sim_lib/fpga_spram.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/gpio0.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/ls_sub_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/matrix.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/pdu_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/pwm.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/retu_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/rtc.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/sms.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/smu_top.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/params/timers_params.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim1.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim2.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim3.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim4.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim5.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim6.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/tim7.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/usi0.v"]"\
 "[file normalize "$origin_dir/src/designs/wujian100/soc/usi1.v"]"\
...
set _xil_proj_name_ "wujian100_basys3_base"
...
set script_file "wujian100_basys3_base.tcl"
...
set_property -name "board_part_repo_paths" -value "C:/Users/user/AppData/Roaming/Xilinx/Vivado/2022.1/xhub/board_store/xilinx_board_store" -objects $obj
...
set file "$origin_dir/src/designs/wujian100/soc/params/apb1_params.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/src/designs/wujian100/soc/params/timers_params.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/src/designs/wujian100/soc/params/wdt_params.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/constraints/XC7A200T3B.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constraints/XC7A200T3B.xdc"
set file [file normalize $file]
