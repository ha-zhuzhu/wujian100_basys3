...
##
## BuildSet
ProjectName            :=wujian100_open-vga
...
User                   :=Shire
Date                   :=18/03/2023
CDKPath                :="D:/Program Files/C-Sky/CDK"
ToolchainPath          :=D:/Program Files/C-Sky/CDKRepo/Toolchain/XTGccElfNewlib/V2.6.1/R/
...
ObjectsFileList        :=wujian100_open-vga.txt
...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch). $(IncludeSwitch)../../../../../board/wujian100_open_evb/include $(IncludeSwitch)../../../../../csi_core/include $(IncludeSwitch)../../../../../csi_driver/include $(IncludeSwitch)../../../../../csi_driver/wujian100_open/include $(IncludeSwitch)../../../../../csi_kernel/include $(IncludeSwitch)../../../../../libs/include $(IncludeSwitch)../configs  
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	$(LinkerName) $(OutputSwitch) $(IntermediateDirectory)/$(OutputFile)$(ExeSuffix) $(LinkerNameoption) $(LinkOtherFlagsOption)  @$(ObjectsFileList) $(LibraryPathSwitch)E:/Project/T-HEAD/course/wujian100_basys3/sdk/libs  -Wl,--whole-archive $(LibrarySwitch)newlib_wrap   -Wl,--no-whole-archive  $(LinkOptions) $(LibPath) $(Libs)
...
$(IntermediateDirectory)/vga_vga$(ObjectSuffix): ../vga.c  
	$(CC) $(SourceSwitch) ../vga.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/vga_vga$(ObjectSuffix) -MF$(IntermediateDirectory)/vga_vga$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/vga_vga$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/vga_vga$(PreprocessSuffix): ../vga.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/vga_vga$(PreprocessSuffix) ../vga.c
